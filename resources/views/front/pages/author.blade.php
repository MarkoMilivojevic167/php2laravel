...
<div class="indexMenu relative ">
            <div class="menuImage">
                <p>Author</p>
                <img src="https://markoitech.000webhostapp.com/assets/images/autor.jpg" alt="marco restaurant"/>
            </div>
            <div class="menuText oneProductText">
                <ul>
                    <li class='productHeader'>Marko Milivojević</li>
                    <li class='productHeader'><a class="homeButton" href="{{ url('/news') }}">DOKUMENTACIJA</a></li>
